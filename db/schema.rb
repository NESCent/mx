...
ActiveRecord::Schema.define(:version => 20120308020236) do
  ...
  add_index "containers", ["creator_id"], :name => "creator_id"
  add_index "containers", ["proj_id"], :name => "proj_id"
  add_index "containers", ["updator_id"], :name => "updator_id"
  ...
  create_table "projs", :force => true do |t|
    ...
    t.string    "default_stage"
    t.string    "recaptcha_private_API_key"
    t.string    "recaptcha_public_API_key"
  end
  ...
  add_index "specimens", ["container_id"], :name => "container_id"
